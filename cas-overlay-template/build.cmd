...
@if "%DNAME%" == "" set DNAME=CN=casdemo.com,OU=Example,OU=Org,C=US
...
@if "%CERT_SUBJ_ALT_NAMES%" == "" set CERT_SUBJ_ALT_NAMES=dns:casdemo.com,dns:localhost,dns:%COMPUTERNAME%,ip:127.0.0.1
